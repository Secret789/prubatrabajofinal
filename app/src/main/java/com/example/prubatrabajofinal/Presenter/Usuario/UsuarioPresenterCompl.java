...
import com.example.prubatrabajofinal.Model.Historial.ITrayectoriaModel;
...
public class UsuarioPresenterCompl implements IUsuarioPresenter{
    IUsuarioView iUsuarioView;
    View v;
    ArrayList<TrayectoriaModel> lista;
    public UsuarioPresenterCompl(IUsuarioView iUsuarioView, View v){
        this.iUsuarioView=iUsuarioView;
        this.v=v;
    }
    public List<TrayectoriaModel> ObtenerHistorial(int id, String URL){
        ...
        lista =new ArrayList<>();
        JsonArrayRequest jasonArrayRequest =new JsonArrayRequest(URL+"?UsuId="+Integer.toString(id), new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        lista.add(new TrayectoriaModel(
                ...
                iUsuarioView.updateRecicle(lista);
                progressBar.dismiss();
